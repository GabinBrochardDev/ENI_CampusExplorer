...
class Sortie
{
    ...
    #[ORM\Column(type: Types::INTEGER)]  // Modifié pour représenter la durée en minutes
    ...
    public function getDuree(): ?int  // Modifié pour retourner un entier
    {
        return $this->duree;
    }

    public function setDuree(int $duree): static  // Modifié pour accepter un entier
    {
        $this->duree = $duree;
